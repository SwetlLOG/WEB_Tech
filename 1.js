//  Необходимо создать html-страницу с названием 1.html, в которой подключить файл 1.js (его тоже необходимо создать рядом
...
Math.round
const temp_cel = Number.parseFloat(prompt("Введите температуру в градусах цельсия: "));
alert(`Температура по Цельсию:  ${temp_cel}\n Температура по Фаренгейту: ${Math.round((9/5)*temp_cel + 32)}`)
